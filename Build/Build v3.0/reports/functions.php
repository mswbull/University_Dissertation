...
$query1 = "select count(eventdetails_result) AS Wins, club_name, eventdetails_result from club, crew, eventdetails WHERE club.club_id = crew.club_id AND crew.crew_id = eventdetails.crew_id GROUP BY club.club_id";

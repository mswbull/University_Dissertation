...
<body>
        <div id="contain">
                ...
                <div id="content">
                        ...
                        <p>This website has been designed to allow all aspects of the regatta to be ran from one central point. Everything from crew registrations, the programme, the draw, fixtures and results can be viewed from this website. If you are a Rowing Club Secretary you also have the ability to register your club and crews for the regatta online. To do so please login to the admin section below using your username and password.</p>
                </div>

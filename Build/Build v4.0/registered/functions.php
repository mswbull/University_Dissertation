...
function viewdetails($club_id2){
       ...
       echo"</table><p><a href='index.php?mode=viewdetailssub&id=$club_id'>[View Substitute Competitors]</a><br /><br /><a href='index.php?mode=view'>Back</a><br /><br />To report an issue please click <a href='../contactus.php'>here</a>.</p>";
}
...
function viewdetailssub($club_id2){
       ...
       echo"</table><p><a href='index.php?mode=viewdetails&id=$club_id'>[View Primary Competitors]</a><br /><br /><a href='index.php?mode=view'>Back</a><br /><br />To report an issue please click <a href='../contactus.php'>here</a>.</p>";
}

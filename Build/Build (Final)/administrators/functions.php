...
function addAdminstrators(){
        ...
        <form name='myForm' action='index.php?mode=insert' onSubmit='return validateForm()' method='post'>
        <table class='contenttable' border='0'>
                <tr>
                        ...
                        <option value='None' name='None'>Registered Club:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>";
                ...
                <tr>
                        ...
                        <option value='None' name='None'>Administrator Level:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>";
...
function insertAdminstrators(){
         ...
         $addressone= str_replace("'", " ","$addressone");
         $addresstwo= str_replace("'", " ","$addresstwo");
         ...
         echo "<p>An Error has occured : Username already in use, please select another.</p><FORM><p><INPUT TYPE='button' VALUE='Back' onClick='history.go(-1);return true;'></p></FORM>";
        }
}
...
echo"
         ...
         <form name='myForm' action='index.php?mode=update&id=$ID' onSubmit='return validateForm()' method='post'>
         <table class='contenttable' border='0'>
                <tr>

...
function addclub(){
        ...
        <form name='AddClub' action='index.php?mode=insertclub' method='post'>
        ...
        <p><input name='Save' type='submit' value='Save' onClick='javascript: validateMeAdd()'>
        <br /><br /><a href='index.php?mode=viewclubs'>Back</a></p>
        </form>";
}
...
function insertclub(){
         ...
         $club_association= str_replace("'", " ","$club_association");
...
echo"
        ...
        <form name='EditClub' action='index.php?mode=updateclub&id=$ID' method='post'>
        <table class='contenttable' border='0'>
                <tr>
        ...
        <p><input name='Save' type='submit' value='Save' onClick='javascript: validateMeEdit()'>
        <br /><br /><a href='index.php?mode=viewclubs'>Back</a></p>

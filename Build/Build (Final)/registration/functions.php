...
function addcrews(){
       ...
       <h2>Register Crew</h2>
        ...
        <form name='Crew' action='index.php?mode=insertcrews' onSubmit='return validateForm()' method='post'>
        <table class='contenttable' border='0' width='70%'>
                ...
                <tr height='40'>
                        ...
                        <option value='1' name='MS4x'>Event&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>";
                ...
                <tr height='40'>
                        ...
                        <option value='A' name='A'>Crew Designation&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>";
...
function insertcrews(){
         ...
         $cox= str_replace("'", " ","$cox");
         $sbow= str_replace("'", " ","$sbow");
         $stwo= str_replace("'", " ","$stwo");
         $sthree= str_replace("'", " ","$sthree");
         $sstroke= str_replace("'", " ","$sstroke");
...
function editcrews(){
       ...
       <form name='Crew' action='index.php?mode=updatecrews' onSubmit='return validateForm()' method='post'>
       <table class='contenttable' border='0' width='70%'>
                <tr height='35'>
                        <th>Crew Information</td>
                        <th>Primary Competitors</td>

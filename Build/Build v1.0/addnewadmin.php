		...
		<div id="content">
				...
				<table border="0">
					...
					<tr>
						...
						<td>Registered Club:<br /><input name="club" type="text"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>Administrator Level:<br /><select name="level"><option value="Full" name="full">Full</option><option value="Club" name="club">Club</option></select></td>

					</tr>
				</table>
				<p><input name="Cancel" type="button" value="Cancel" onClick="li_index.php"><input name="Save" type="submit" value="Save"></p>
				</form>
		</div>

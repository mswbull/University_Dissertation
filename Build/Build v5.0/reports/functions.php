...
$query1 = "select count(eventdetails_result) AS Wins, club_name, eventdetails_result from club, crew, eventdetails WHERE club.club_id = crew.club_id AND crew.crew_id = eventdetails.crew_id GROUP BY club.club_id, eventdetails_result";
$result1 = @mysql_query($query1, $connection)
or die ("Unable to perform query<br />$query1");

echo"
        <h2>Reports - Rowing Clubs Points</h2><br />
        <table class='ViewTable'>
                <tr>
